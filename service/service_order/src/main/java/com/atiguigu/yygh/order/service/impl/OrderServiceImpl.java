...
import com.atiguigu.yygh.vo.order.*;
...
import com.atiguigu.yygh.order.mapper.OrderMapper;
import com.atiguigu.yygh.order.service.OrderService;
import com.atiguigu.yygh.order.service.WeixinService;
import com.atiguigu.yygh.user.client.PatientFeignClient;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, OrderInfo> implements OrderService {
    ...
    public Long saveOrder(String scheduleId, Long patientId) {
        ...
        System.out.println("就诊人patiend:"+patient);
        if(null == patient) {
            throw new YyghException(ResultCodeEnum.PARAM_ERROR);
        }
        ScheduleOrderVo scheduleOrderVo = hospitalFeignClient.getScheduleOrderVo(scheduleId);
        System.out.println("scheduleOrder:"+scheduleOrderVo);
...
//        }
        ...
        if(result.getInteger("code") == 200) {
            System.out.println("进入到if语句中，说明请求成功！");
